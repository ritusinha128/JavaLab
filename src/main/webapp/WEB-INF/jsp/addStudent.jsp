...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <h1 style="color:#4c4cff">Student Details Portal<a style="margin-left: 20px;" href="${pageContext.request.contextPath}/getStudents" class="btn btn-success" role="button">View Students</a>
      <a style="margin-left: 5px;" href="${pageContext.request.contextPath}/getStudentbyValues" class="btn btn-warning" role="button">Search for Student</a>
      <a style="margin-left: 5px;" href="${pageContext.request.contextPath}/deleteStudentbyValues" class="btn btn-danger" role="button">Delete Student</a>
