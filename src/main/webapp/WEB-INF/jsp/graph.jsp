  ...
  <div class="row content">
    ...
    <div class="col-sm-2 sidenav">
      <div class="well">
		...
		<p style="color:#4c4cff"><a href="${pageContext.request.contextPath}/graph">
		Subjects</a> </p>
...
var myLineChart = new Chart(ctx, {
 ...
 <script type="text/javascript" src="${pageContext.request.contextPath}/vendor/chart.js/Chart.min.js"></script>
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/js/demo/chart-area-demo.js"></script>
  <script type="text/javascript" src="${pageContext.request.contextPath}/js/demo/chart-pie-demo.js"></script>
</html>
