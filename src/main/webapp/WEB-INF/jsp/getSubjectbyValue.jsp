  ...
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <jsp:include page="menu.jsp" />
			    ...
			    <form:form action="/getSubjectbyValues" method="post"
			modelAttribute="attr">
			<p><label>Filter by :</label>&nbsp;<form:select path="attribute">
			              <form:option value="Code" name="Subject Code"/>
			              <form:option value="Sub_Name" name ="Name"/>
			              <form:option value="Sub_sem" name="Semester"/>
