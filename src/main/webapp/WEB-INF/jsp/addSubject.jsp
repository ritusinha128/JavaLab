...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      <h1 style="color:#4c4cff">Student Details Portal<a style="margin-left: 30px;" href="${pageContext.request.contextPath}/getSubjects" class="btn btn-success" role="button">View Subjects</a>
      <a style="margin-left: 10px;" href="${pageContext.request.contextPath}/getSubjectbyValues" class="btn btn-warning" role="button">Search for Subject</a>
       </h1>
