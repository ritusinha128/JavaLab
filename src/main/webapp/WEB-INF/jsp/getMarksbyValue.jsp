  ...
  <div class="row content">
    <div class="col-sm-2 sidenav">
      <jsp:include page="menu.jsp" />
			    ...
			    <form:form action="/getMarksbyValue" method="post"
			modelAttribute="attr">
			<p><label>Filter by :</label>&nbsp;<form:select path="attribute">
			              <form:option value="Student_Usn" name="Student_USN"/>
			              <form:option value="Grade" name ="Grade"/>
			              <form:option value="Sub_code" name="Sub_code"/>
