...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <p> Welcome to the Student Details Portal. Click on the links on the left to view student details.</p>
      <hr>
      <img style="height:auto; width:570px; margin-left:85px" src="https://dirkjan.co/wp-content/uploads/2019/03/Citigroup-CANVAS-Group-Meeting.gif"/>
    </div>
    <div class="col-sm-2 sidenav">
